	...
	<div id="wrapper">
		...
		<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion toggled" id="accordionSidebar">
			...
			<a class="sidebar-brand d-flex align-items-center justify-content-center" href="institute_view.php">
				...
				<div class="sidebar-brand-text mx-3"><?php echo  $_SESSION['user']['institute_name']; ?></div>
			</a>
						...
						<li class="nav-item dropdown no-arrow">
							<!-- <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								<span class="mr-2 d-none d-lg-inline text-gray-600 small">
									<?php echo  $_SESSION['user']['institute_name']; ?>
								</span>
								<img class="img-profile rounded-circle" src="../../img/logo.png">
							</a> -->
							<a class="nav-link dropdown-toggle" href="institute_view.php?logout='1'">logout</a>
